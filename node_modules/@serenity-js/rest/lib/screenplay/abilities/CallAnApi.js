        ...
        return promisedResponse
            ...
            switch (true) {
                case /timeout.*exceeded/.test(rejected.message):
                    throw new core_1.TestCompromisedError(`The request has timed out`, rejected);
                case /Network Error/.test(rejected.message):
                    throw new core_1.TestCompromisedError(`A network error has occurred`, rejected);
                case rejected instanceof TypeError:
                    throw new core_1.ConfigurationError(`Looks like there was an issue with Axios configuration`, rejected);
                case !rejected.response:
                    throw new core_1.TestCompromisedError(`The API call has failed`, rejected);
                default:
