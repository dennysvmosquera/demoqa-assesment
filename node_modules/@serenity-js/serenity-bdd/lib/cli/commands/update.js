...
module.exports = {
    ...
    handler: (argv) => {
        ...
        return Promise.resolve().then(() => core_1.actorCalled('Serenity/JS Updater').attemptsTo(assertions_1.Check.whether(screenplay_1.FileExists.at(pathToArtifact), assertions_1.isTrue())
