...
class Credentials extends tiny_types_1.TinyType {
    ...
    static fromString(value) {
        ...
        tiny_types_1.ensure('Credentials', value, matches(/(.*):(.*)/, `follow the "<username>:<password>" format`));
        const index = value.indexOf(':');
        return new Credentials(value.substring(0, index), value.substring(index + 1));
    }
}
